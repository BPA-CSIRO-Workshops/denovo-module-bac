...
\setModuleTitle{Bacterial Assembly}
\setModuleAuthors{%
  Torsten Seeman \mailto{jane.bloggs@example.com} \\
...
\begin{itemize}
  \item Perform a bacterial assembly using velvet 
  \item Visualise the assembly graph using bandage
\end{itemize}
% END KLOs
...
\subsection{Graph Visualisation using Bandage}
